export default{
    template:`<div>
            ...
            <div class="row justify-content-center" style="height:35rem;">
                <div class="col-2 box p-5 pt-5 bg-light" style="box-shadow: 0px 0px 100px rgba(0,0,0,0.3)!important;border-radius: 20px;background: rgba(210,210,210,0.3);height: 30rem;width: 20rem;">
                    ...
                    <input type="email" name='email' id='email' class="form-control" v-model="userdata.email" required/></label>
